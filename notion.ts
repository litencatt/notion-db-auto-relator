...
export const getDbPages = async (notion: Client, databaseId: string): Promise<QueryDatabaseResponse> => {
...
export const getParentPages = async (notion: Client, databaseId: string, columnName: string): Promise<ParentPage[]> => {
  const res = await notion.databases.query({
    database_id: databaseId,
  })
...
export const searchDbPageIds = async (notion: Client, databaseId: string, parentPage:ParentPage) :Promise<string[]> => {
...
// @ts-ignore
export const updateRelation = async (notion: Client, parentId: string, childIds: any[], relateColumnName: string) => {
...
export const getDbMultiSelect = async (notion: Client, databaseId: string, propName: string): Promise<string[]> => {
